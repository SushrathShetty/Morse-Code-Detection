...
##    Label(register_screen, text="").place(x = 150,y = 100)
    ...
    username_entry = Entry(register_screen, text="",font=("impact", 25))
    ...
    password_entry = Entry(register_screen, text="", show='*',font=("times", 25))
    ...
    question1 = Entry(register_screen, text="", show='*',font=("impact", 25))
...
##    q_verify = StringVar()
    ...
    username_login_entry = Entry(login_screen, text=""_verify,font=("times", 25,"bold"))
...
##    Label(login_screen, text="").pack()
    ...
    password_login_entry = Entry(login_screen, text=""_verify, show= '*',font=("times", 25,"bold"))
