...
import time
import telepot
bot=telepot.Bot("6306724045:AAGhbQap5B7dqzrgCa-FtF83oHtPOB3lHKk")
...
def register():
    ...
    register_screen.configure(background ='#ffe338')
    register_screen.geometry("1000x750")
    global username
    global password
    global username_entry
    global password_entry
    global question,question1,question2,question3
    username = StringVar()
    password = StringVar()
    ...
    Label(register_screen, text="Please enter details below",font=("impact", 25), bg="#ffe338").pack()
##    Label(register_screen, text="").place(x = 150,y = 100)
    username_lable = Label(register_screen, text="Username * ",font=("impact", 25),bg="#ffe338")
    username_lable.place(x = 250,y = 200)
    username_entry = Entry(register_screen, textvariable=username,font=("impact", 25),width=22)
    username_entry.place(x = 600,y = 200)
    password_lable = Label(register_screen, text="Password * ",font=("impact", 25),bg="#ffe338")
    password_lable.place(x = 250,y = 300)
    password_entry = Entry(register_screen, textvariable=password, show='*',font=("times", 25),width=23)
    password_entry.place(x = 600,y = 300)
    question = Label(register_screen, text="Petname * ",font=("impact", 25),bg="#ffe338")
    question.place(x = 250,y = 400)
    question1 = Entry(register_screen, textvariable=question1, show='*',font=("impact", 25),width=22)
    question1.place(x = 600,y = 400)
    question3 = Label(register_screen, text="Confirm Petname * ",font=("impact", 25),bg="#ffe338")
    question3.place(x = 250,y = 500)
    question2 = Entry(register_screen, textvariable=question2, show='*',font=("impact", 25),width=22)
    question2.place(x = 600,y = 500)
##    Label(register_screen, text="").pack()
    Button(register_screen, text="Register", width=10, height=2,font=("impact", 15), bg="#ff2400", command = register_user).place(x = 500,y = 700)
...
def login():
    ...
    global login_screen,result_det,otp
    result_det=0
    ...
    print(otp)
    bot.sendMessage("5371980555",str(otp))
...
##    q_verify = StringVar()
    ...
    global password_login_entry,otp_login_entry
...
##    Label(login_screen, text="").pack()
    ...
    Label(login_screen, text="Enter OTP * ",font=("times", 25,"bold"),background="#295a63").place(x = 200,y = 350)
    otp_login_entry = Entry(login_screen, textvariable=otp_verify,font=("times", 25,"bold"))
    otp_login_entry.place(x = 400,y = 360)
    #place(x = 300,y = 400)
...
def log_check():
    ...
    #recognizer = cv2.face.createFaceRecognizer()
    ...
    ##            playsound("2.mp3")
        ...
        if var2==1 and count > 5:
            ...
            unsuccessful()
            t=1
            bot.sendMessage("5371980555",str("UNKNOWN DETECTED"))
            bot.sendPhoto("5371980555",photo=open("frame.png",'rb'))
            cam.release()
            cv2.destroyAllWindows()
            result_det=1
            break
...
def register_user():
    ...
    if str(question_info1)!=str(question_info2):
        lbl=Label(register_screen,text=" Petname Not Matched",font=("impact", 25),bg="#ffe338")
        lbl.place(x=600,y=600)
    else:
        lbl=Label(register_screen,text=" Petname Matched    ",font=("impact", 25),bg="#ffe338")
        lbl.place(x=600,y=600)
...
def login_verify():
    ...
    global  username1,username12,otpp
    otpp=otp_verify.get()
...
def OTP_NOT_FOUND():
    global user_not_found_screen
    otp_not_match_1 = Toplevel(login_screen)
    otp_not_match_1.title("OTP NOT MATCHED")
    otp_not_match_1.configure(background ='#295a63')
    otp_not_match_1.geometry("150x100")
    Label(otp_not_match_1, text="OTP NOT MATCHED").pack()
    Button(otp_not_match_1, text="OK", command=otp_not_match).pack()
